...
from models import UserGroup, AdminFunction
...
class UserGroupAdmin(admin.ModelAdmin):
    filter_horizontal = ('users', 'admins', 'permissions', 'groups', 'admin_functions')
    non_superuser_disabled_fields = ('name', 'admins', 'permissions', 'groups', 'admin_functions', 'extra')
...
class AdminFunctionAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        ...
        return qs.filter(app_id=request.REQUEST.get('app_id') or self.app_id)

...
from pyutil.django.user_group.models import AdminFunction
from pyutil.django.user_group.types import AdminFunctionStatus
...
class FunctionUrlPatternsCache(object):
    ...
    def _get_option():
        ...
        新的写法：
        URL_AUTH_KEY = 'crawl/user/function_url_patterns'
        :return:
        """
        ...
        if options:
            ...
            cache_key = getattr(django_settings, 'URL_AUTH_CACHE_KEY')
        if not cache_key:

...
class Unpacker(object):
    ...
    def _fb_read(self, n, write_bytes=None):
        ...
        if (write_bytes is None and self._fb_buf_i < len(buffs)
                and self._fb_buf_o + n < len(buffs[self._fb_buf_i])):
            self._fb_buf_o += n
        ...
        while len(ret) != n:
            ...
            if self._fb_buf_i == len(buffs):
                ...
                continue
            ret += buffs[self._fb_buf_i][self._fb_buf_o:
    ...
    def _fb_unpack(self, execute=EX_CONSTRUCT, write_bytes=None):
        ...
        if typ == TYPE_MAP:
            ...
            if self._object_pairs_hook is not None:
                ret = self._object_pairs_hook((self._fb_unpack(
                    EX_CONSTRUCT, write_bytes), self._fb_unpack(
                        EX_CONSTRUCT, write_bytes)) for _ in xrange(n))
            else:
                ret = {}
                for _ in xrange(n):
    ...
    def _pack(self,
        ...
        while True:
            ...
            if isinstance(obj, dict):
                return self._fb_pack_map_pairs(

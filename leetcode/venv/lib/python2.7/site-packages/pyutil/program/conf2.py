...
from pyutil.program import is_python3

if is_python3:
    from urllib import parse
    sys.path = [p for p in sys.path if 'python3' in p] + [p for p in sys.path if 'python3' not in p]
else:
...
class ConfParse(object):
    ...
    def parse_dummy_service_instance(self, conf_service_name):
        ...
        _, inst = bridge.try_dummy_translate(conf_service_name)
        return inst

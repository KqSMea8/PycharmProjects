...
class ImpressionCacheClient(object):
    def __init__(self, servers, timeout=0.3, conn_timeout=0.1, max_retries=3, **kwargs):
        self._client = ThriftRetryClient(ImpressionCache.Client, servers, timeout=timeout, conn_timeout=conn_timeout, max_retries=max_retries, accelerated=True, **kwargs)

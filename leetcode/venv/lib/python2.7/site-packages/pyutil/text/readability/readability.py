...
def main():
    ...
    try:
        doc = Document(file.read(), debug=options.verbose, url=options.url)
        print '----------------------------------------------------------------'
        print 'title', doc.title().encode(enc, 'replace')
        print '----------------------------------------------------------------'
        print 'short_title', doc.short_title().encode(enc, 'replace')
        print '----------------------------------------------------------------'
        print 'summary', re.sub('[\n\r\t]+', '\n', doc.summary(html_partial=True).encode(enc, 'replace').replace('&#13;', '\n'))
        print '----------------------------------------------------------------'
    finally:
        file.close()
